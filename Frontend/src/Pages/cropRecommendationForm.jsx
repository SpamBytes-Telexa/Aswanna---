...
export default function CropRecommendationsApp() {
  ...
  const CropForm = ({ onSubmit }) => (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.prismic.io/intuzwebsite/ee51a4e5-4769-4a1b-b4a4-ce1ae93731a5_Banner%402x.png?auto=compress,format')",
      }}
    >
      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <button
              onClick={onBack}
              className="flex items-center text-white-600 hover:text-white-800 transition-colors"
            >
                    ...
                    {recommendation.geminiResponse.tips &&
                      recommendation.geminiResponse.tips.length > 0 && (
                        <div className="mb-4">
                          ...
                          <ul className="list-disc list-inside text-sm text-gray-600">
                            {recommendation.geminiResponse.tips.map(
                              (tip, i) => (
                                <li key={i}>{tip}</li>
                              )
                            )}
